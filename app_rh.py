...
# ====================== MÓDULO DE COMPRAS ======================
try:
    from compras_streamlit import render_compras
    COMPRAS_ENABLED = True
except Exception:
    COMPRAS_ENABLED = False
...
with aba12:
    if COMPRAS_ENABLED:
        ...
        st.error("❌ Módulo de Compras não pôde ser carregado. Verifique se o arquivo `compras_streamlit.py` está na mesma pasta.")
